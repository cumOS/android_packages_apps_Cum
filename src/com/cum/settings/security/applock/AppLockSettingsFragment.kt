...
package com.cum.settings.security.applock
...
import com.cum.settings.fragments.CumDashboardFragment

@SearchIndexable
class AppLockSettingsFragment : CumDashboardFragment(),
    MenuItem.OnMenuItemClickListener {

    private var debugEnabled = SystemProperties.get(DEBUG_PROPERTY, null) == LEVEL_DEBUG
    private var handledClick = false

    override protected fun getPreferenceScreenResId() = R.xml.cum_settings_app_lock
    ...
    companion object {
        ...
        @JvmField
        val SEARCH_INDEX_DATA_PROVIDER = BaseSearchIndexProvider(R.xml.cum_settings_app_lock)
    }
}