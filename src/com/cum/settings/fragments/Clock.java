/*
 * Copyright (C) 2019-2022 The CumOS Project
 *
...
import com.cum.settings.fragments.Clock;
import com.cum.settings.preferences.SecureSettingSwitchPreference;
...
public class Clock extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.cum_settings_status_bar_clock);
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.cum_settings_status_bar_clock);
}